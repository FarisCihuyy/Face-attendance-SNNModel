...
# ============================ CONFIG ============================
IMG_SIZE = (160, 160)
TRAINING_DIR = "data/training"  # Your existing structured data (faris/anchor, faris/positive)
LFW_DIR = "data/lfw"  # LFW dataset (flat structure: person_name/*.jpg)
REGISTERED_DIR = "data/registered"  # Your registered users (faris/*.jpg, nicolas/*.jpg)

BATCH_SIZE = 16
EPOCHS = 50
MARGIN = 0.5  # Increased margin for better separation
MODEL_PATH = "siamese_triplet_optimal_v2.keras"

MIN_IMAGES_PER_PERSON = 2  # Minimum images required per person

# =================== CUSTOM L2 NORMALIZATION LAYER ===============
class L2Normalization(layers.Layer):
    """Custom L2 Normalization layer - bisa di-serialize dengan aman"""
...
def load_all_persons():
    """
    Load semua person dari berbagai sumber:
    1. LFW dataset (flat structure)
    2. Registered users (flat structure)
    3. Training data (structured: anchor/positive)
    ...
    # 2. Load Registered Users (Flat Structure)
    ...
    # 3. Load Structured Training Data (anchor/positive folders)
